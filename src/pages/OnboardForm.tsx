...
export default function BusinessQuiz() {
  ...
  const nextStep = () => {
    ...
    if (step === 1 && !formData.businessName) {
      toast.error("Business name is missing", {
        description: "Please provide at least the product name to continue.",
      });
      return;
    }
                    ...
                    <div className="space-y-4 pt-2">
                      ...
                      <div className="space-y-3 p-4 border rounded-md">
                        ...
                        <div className="space-y-3">
                          ...
                          <div className="space-y-1">
                            <Label htmlFor="workerServices">
                              Services Provided
                            </Label>
                            <Textarea
                              id="workerServices"
                              name="services"
                              placeholder="What services does this team member provide?"
                              rows={2}
              ...
              <div className="space-y-2">
                ...
                <div className="grid grid-cols-1 gap-2 sm:grid-cols-2">
                  {[
                    ...
                    isBeautySalon ? "Loyalty Program" : "Delivery Options",
                  ].map((feature) => (
                    <div
                      key={feature}
